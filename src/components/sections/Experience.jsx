  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-gradient-to-l from-premium/75 to-premium/30 p-[2px] rounded-4xl shadow-lg">
        <motion.div
          variants={fadeUp}
          className="grid md:grid-cols-[1fr_300px] gap-6 border border-white/20 rounded-4xl  bg-black overflow-hidden"
        >
          {/* Text */}
          <div className="p-8">
            ...
            <p className="text-white tracking-wide text-[17px] mt-3">
              ...
              and developed responsive user interfaces using React.js and
              Tailwind CSS, and handled REST API integrations to manage dynamic
              data across multiple projects. I collaborated with backend
              developers to ensure smooth functionality and performance and
              received an official Experience Letter for my contributions.
            </p>
